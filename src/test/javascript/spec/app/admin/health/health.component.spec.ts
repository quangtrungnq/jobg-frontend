...
import { JobgTestModule } from '../../../test.module';
import { JobgHealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { JobgHealthService } from '../../../../../../main/webapp/app/admin/health/health.service';

describe('Component Tests', () => {

    describe('JobgHealthCheckComponent', () => {

        let comp: JobgHealthCheckComponent;
        let fixture: ComponentFixture<JobgHealthCheckComponent>;
        let service: JobgHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [JobgTestModule],
                declarations: [JobgHealthCheckComponent],
                providers: [
                    JobgHealthService,
                    {
                        provide: NgbModal,
            ...
            }).overrideTemplate(JobgHealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(JobgHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(JobgHealthService);
        });
